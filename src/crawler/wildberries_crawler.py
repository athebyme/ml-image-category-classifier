...
class WildberriesCrawler:
    ...
    def __init__(self, category_targets, max_workers=DEFAULT_MAX_WORKERS):
        """
        ...
        self.product_parser = ProductParser(self.browser_manager, self.captcha_solver)
        self.storage = JsonStorage()
        self.search_parser = SearchParser(self.browser_manager, self.captcha_solver)
